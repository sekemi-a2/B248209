...
```
Figure 3.4 highlighted clear increases in both absolute and percentage change across all Health Boards. The Western Isles, the fourth most deprived Health Board, recorded the highest rise in both absolute and proportional terms, whereas Shetland, the second least deprived Health Board, showed the smallest increases. Although all Health Boards experienced growth, the ranking of areas by absolute versus percentage change did not fully align with deprivation order, indicating variation in prescribing increases that was not solely explained by socioeconomic status.
...
Colhoun, H.M. & McKnight, J. (2020). Diabetes in Scotland: a rising tide. The Lancet Diabetes & Endocrinology 8, 769-770. https://doi.org/10.1016/S2213-8587(20)30124-8
